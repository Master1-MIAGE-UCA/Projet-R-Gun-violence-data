...
#### Conclusion : pour alpha = 5%, on a t_nbMort ( 0.09824325 ) appartenant à l'intervalle [ -2.131847 ; 2.131847 ]
#### Ainsi, on ne peut pas refuser H0
...
```
#### Conclusion : pour alpha = 5%, on a t_nbMort ( 0.3726553 ) appartenant à l'intervalle [ -2.131847 ; 2.131847 ]
#### Ainsi, on ne peut pas refuser H0
...
#### Conclusion : pour alpha = 5%, on a t_nbMort ( 0.01011114 ) appartenant à l'intervalle [ -2.131847 ; 2.131847 ]
#### Ainsi, on ne peut pas refuser H0
